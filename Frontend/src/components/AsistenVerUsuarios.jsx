...
function AsistenVerUsuarios() {
    ...
    useEffect(() => {
        ...
        fetch(`${config.apiUrl}/userRoute/usuarios`, { // Usa config.apiUrl
            headers: {
            ...
            .then(data => {
                ...
                const filteredData = data.filter(user => 
                    !user.Roles?.some(role => role.role_name === 'Conductor')
                  );
                setUsuarios(filteredData);
                setFilteredUsuarios(filteredData); // Inicialmente los usuarios filtrados son los mismos que los cargados
            })
                    ...
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Detalles Usuario</h5>
                                <button
                                    type="button"
                                    className="btn-close"
...
export default AsistenVerUsuarios;
